...
const codepathCert = 'https://i.postimg.cc/7YG4yy7n/codepath-certification.png';
const globalItCert = 'https://i.postimg.cc/59FJhV8q/global-it-certificate.png';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="p-6 hover:shadow-lg transition-shadow bg-card border-border/30">
                  <div className="flex items-start gap-4">
                    <div className="w-80 h-64 rounded-lg overflow-hidden flex-shrink-0 cursor-pointer" onClick={() => window.open(codepathCert, '_blank')}>
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow bg-card border-border/30">
                  <div className="flex items-start gap-4">
                    <div className="w-80 h-64 rounded-lg overflow-hidden flex-shrink-0 cursor-pointer" onClick={() => window.open(globalItCert, '_blank')}>
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow bg-card border-border/30">
                  <div className="flex items-start gap-4">
                    <div className="w-80 h-64 rounded-lg overflow-hidden flex-shrink-0 cursor-pointer" onClick={() => window.open(breakthroughCert, '_blank')}>
                ...
                <Card className="p-6 hover:shadow-lg transition-shadow bg-card border-border/30">
                  <div className="flex items-start gap-4">
                    <div className="w-80 h-64 rounded-lg overflow-hidden flex-shrink-0 cursor-pointer" onClick={() => window.open(goldmanSachsCert, '_blank')}>
